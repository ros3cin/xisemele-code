...
public class EditorTest {
   ...
   public void testRename() {
      ...
      Editor editor = 
         XisemeleFactory.newXisemele().createEditor(original)
         .defineAsCurrent("root").rename("rootElement")
         .defineAsCurrent("rootElement/a").rename("nodeA")
         .defineAsCurrent("rootElement/b").rename("nodeB")
         .defineAsCurrent("rootElement/nodeB/c").rename("nodeC");
   ...
   public void testRemove() {
      ...
      Editor editor = 
         XisemeleFactory.newXisemele().createEditor(original)
         .defineAsCurrent("root/a").remove()
         .defineAsCurrent("root/b")
            .removeChildren("d")
            .removeAttribute("attr1")
         .defineAsCurrent("root/e")
            .removeChild("g")
            .removeAttributes()
         .defineAsCurrent("root/h").removeChildren();
   ...
   public void testValue() throws Exception {
      ...
      Editor editor =
         XisemeleFactory.newXisemele().createEditor(original)
         .defineAsCurrent("root/a").value("new value")
         .defineAsCurrent("root/b").value(date, "dd/MM/yyyy");
   ...
   public void testAttribute() throws Exception {
      ...
      Editor editor =
         XisemeleFactory.newXisemele().createEditor(original)
         .attribute("attrRoot", "value")
         .defineAsCurrent("root/a").attribute("attr1", "new value")
         .defineAsCurrent("root/b").attribute("date", date, "dd/MM/yyyy");
   ...
   public void testFormatter() {
      ...
      Editor editor =
         ...
         .createEditor(original)
            .defineAsCurrent("root/a").value(new Long("123"))
            .defineAsCurrent("root/b").value(Boolean.TRUE)
            .defineAsCurrent("root/c").attribute("long", new Long("456"))
            .defineAsCurrent("root/d").attribute("boolean", Boolean.TRUE);
