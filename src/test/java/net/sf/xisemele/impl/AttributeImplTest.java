...
public class AttributeImplTest {
   ...
   public void testEqualsHashCode() {
      ...
      assertEquals(new AttributeImpl("a", new ValueImpl(null, provider, "10")), 
                   new AttributeImpl("a", new ValueImpl(null, provider, "10")));
      assertEquals(new AttributeImpl("a", new ValueImpl(null, provider, "10")).hashCode(), 
                   new AttributeImpl("a", new ValueImpl(null, provider, "10")).hashCode());
      assertFalse(new AttributeImpl("a", new ValueImpl(null, provider, "10"))
                  .equals(new AttributeImpl("b", new ValueImpl(null, provider, "10")).hashCode()));
   }
}
